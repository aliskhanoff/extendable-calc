...
import {  CLR, SUB, ADD, DIV, MUL, EQM, SQRT, CHANGE_SIGN, BACKSPACE, PNT } from '@api'
...
export const Frame = ({ className = '', display, left, right, footer, ...rest }) => {
  ...
  return (
    <section {...rest} className={ `frame md:scale-125 dark:bg-slate-700 lg:scale-150 shadow-sm gap-1 transition-colors ${className}` }>
        ...
        <footer className="footer py-2 self-center w-full h-auto grid grid-cols-5 gap-1 grid-rows-1">
                ...
                <ActionButton action={{ type: PNT }}>.</ActionButton>
                <ThemeButton />
